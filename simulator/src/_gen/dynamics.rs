...
pub fn update_dynamics(
    ...
    let temp_23 = temp_15.broadcast_div(&temp_22)?;
    let temp_24 = temp_14.broadcast_mul(&temp_23)?;
    let temp_25 = temp_24.sum_keepdim(1)?;
    let temp_26 = temp_10.broadcast_mul(&temp_25)?;
    let temp_27 = temp_26.broadcast_mul(&temp_0)?;
    let temp_28 = s_vel_x.broadcast_add(&temp_27)?;
    let vel_x = temp_28;
    let temp_29 = temp_11.broadcast_mul(&temp_18)?;
    let temp_30 = temp_29.broadcast_mul(&temp_23)?;
    let temp_31 = temp_30.sum_keepdim(1)?;
    let temp_32 = temp_10.broadcast_mul(&temp_31)?;
    let temp_33 = temp_32.broadcast_mul(&temp_0)?;
    let temp_34 = s_vel_y.broadcast_add(&temp_33)?;
    let vel_y = temp_34;
    let size = s_size;
